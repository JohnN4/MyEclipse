...
public class RegularExpressions {
	...
	public static void main(String[] args) {
		...
		/*
		 * String dateStr = reader.next(); if (dateValidated(dateStr))
		 * System.out.println("Valid date"); else System.out.println("Invalid Date");
		 */
		System.out.println(
				"Enter valid password (first character letter, only upper case and lower case letters, digits and special characters $/-_, length between 6 and 1");
