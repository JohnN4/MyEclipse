...
public class Costume {
	...
	public String toString() {
		return "Costume [id=" + id + ", name=" + name + ", genre=" + genre + ", scariness=" + scariness
				+ ", creativeness=" + creativeness + ", cuteness=" + cuteness + ", authenticity=" + authenticity + "]";
	}

	public Costume(int id, String name, String genre, int scariness, int creativeness, int cuteness, int authenticity) {
		super();
		this.id = id;
		this.name = name;
		this.genre = genre;
